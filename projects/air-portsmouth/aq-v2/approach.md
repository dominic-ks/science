# Air Portsmouth AQ — Project Approach

This file defines how Air Portsmouth device work should be run. It builds on the repository-wide [approach](../../../approach.md) and adapts it for low-cost air quality monitoring.
...
- BME680 gas resistance output should be treated as experimental unless further characterised
